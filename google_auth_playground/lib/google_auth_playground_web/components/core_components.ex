defmodule GoogleAuthPlaygroundWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GoogleAuthPlaygroundWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GoogleAuthPlaygroundWeb.Gettext, "errors", msg, opts)
    end
  end
